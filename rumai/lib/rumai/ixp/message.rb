  ...
  module IXP
    ...
    module Stream
      ...
      def read_9p num_bytes
        puts "DBG: Rumai::IXP::Stream#read_9p num_bytes=#{num_bytes.inspect}"
      ...
      def self.included target
        class << target
          ...
          def from_9p stream, msg_class = self
            puts "DBG: Rumai::IXP::Struct#from_9p stream=#{stream.inspect}"
            puts "DBG: Rumai::IXP::Struct#from_9p msg_class=#{msg_class.inspect}"
            msg = msg_class.new
            puts "DBG: Rumai::IXP::Struct#from_9p msg=#{msg.inspect}"
            msg.load_9p(stream)
            msg
          end
        end
    ...
    class Fcall
      ...
      class << self
        ...
        def from_9p stream
          ...
          puts "DBG: Rumai::IXP::Fcall#from_9p size=#{size.inspect}"
          puts "DBG: Rumai::IXP::Fcall#from_9p type=#{type.inspect}"
          puts "DBG: Rumai::IXP::Fcall#from_9p stream=#{stream.inspect}"

          unless fcall = TYPE_TO_CLASS[type]
            puts "DBG: Rumai::IXP::Fcall#from_9p raising from type=#{type.inspect}"
            raise Error, "illegal fcall type: #{type}"
          end

          # puts "DBG: Rumai::IXP::Fcall#from_9p fcall=#{fcall.inspect}"
    ...
    class Rerror < Fcall
      puts "DBG: Rumai::IXP::Rerror self=#{self.inspect}"
      field     :ename   , String
    end
