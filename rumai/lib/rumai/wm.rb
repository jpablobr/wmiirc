...
module Rumai
  ...
  class WidgetNode < Node
    ...
    def initialize id, path_prefix
      ...
      puts "DBG: id=#{id.inspect}"
      puts "\033[2;37;41DBG: path_prefix=#{path_prefix.inspect}\033[0m"
  ...
  class View < WidgetNode
    def initialize view_id
      puts "DBG: view_id=#{view_id.inspect}"
      super view_id, '/tag'
    end
    ...
    def initialize file_name, side
      prefix =
        case @side = side
          ...
          puts "DBG: Node::Barlet#initialize side=#{side.inspect}"
          raise ArgumentError, side
        end

      puts "DBG: Node::Barlet#initialize prefix=#{prefix.inspect}"
